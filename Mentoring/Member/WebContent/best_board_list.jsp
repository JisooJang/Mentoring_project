...
<%
	...
	if(!boardIter.hasNext()) {
		...
		%>
			...
			<td><a href="board_all.m2?board_code=<%=board.getBoard_code() %>&command=retrieveBoard" target="_blank"><%=board.getSubject() %></a><span class="reply"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<%=board.getReplycount() %>)</span></td>
	...
	<text align="right"><a href="board_list.m2?command=bestBoardByReccount">'좋아요' 많은 게시물 보기</a></text>
	<a href="board_list.m2?command=retrieveBoardList">게시글</a>
</div>
</head>
<body>
